use crate::map_builders::{BuilderChain, DrunkardsWalkBuilder, XStart, YStart, AreaStartingPosition,
...
pub fn limestone_deep_cavern_builder(new_depth: i32, width: i32, height: i32) -> BuilderChain {
    ...
    chain.with(DistantExit::new());
    chain.with(CaveDecorator::new());
    chain.with(PrefabBuilder::sectional(crate::map_builders::prefab_builder::prefab_sections::ORC_CAMP));
    chain
}
